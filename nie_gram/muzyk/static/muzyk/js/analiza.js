...
function showHide() {
    ...
    function calcWynik() {
        let of = document.getElementsByName("oferta")[0].value;
        ...
        let wyn = (Number(of) *(1- (Number(pod) / 100))) - Number(inn) - Number(transport) - Number(noc);
        document.getElementsByName("wyn")[0].value = Math.round(wyn*100)/100 // value.toFixed(2);
    }
